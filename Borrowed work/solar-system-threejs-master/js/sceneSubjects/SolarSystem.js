...
function SolarSystem(scene, time) {
  ...
  this.update = function (time) {
    ...
    mercuryOrbit.rotation.y = time / 5 / 0.88; // rotate around the sun
    mercuryMesh.rotation.y = time / 200 / 14.076; // rotate the planet

    venusOrbit.rotation.y = time / 5 / 2.247;
    venusMesh.rotation.y = time / 200 / 2.43;

    earthOrbit.rotation.y = time / 5 / 1000 / 3.6525;
    earthMesh.rotation.y = time / 200 / 0.01;

    moonOrbit.rotation.y = time / 5 / 10 / 0.0273;
    moonMesh.rotation.y = time / 200 / 0.027;

    marsOrbit.rotation.y = time / 5 / 6.87;
    marsMesh.rotation.y = time / 200 / 0.012;

    jupiterOrbit.rotation.y = time / 5 / 43.326;
    jupiterMesh.rotation.y = time / 200 / 0.0041;

    saturnOrbit.rotation.y = time / 5 / 107.6;
    saturnMesh.rotation.y = time / 200 / 0.0044;

    uranusOrbit.rotation.y = time / 5 / 306.9;
    uranusMesh.rotation.y = time / 200 / -0.0072;

    neptuneOrbit.rotation.y = time / 5 / 601.9;
